...
### M8: Peer judging
- Status: `[x] done (2026-06-10, <pending>)` — pure circulant judge-assignment kernel (balanced coverage, never-own, seeded), assign-judges slice wired into the cron, cast-vote slice + anonymized judging UI, aggregation via M3 kernel; 308 unit + 13 e2e green
- Depends on: M6
