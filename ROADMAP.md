...
### M7: Pool anti-cheat
- Status: `[x] done (2026-06-10, PENDING)` — originality + moderation kernel, `infra/similarity` seam, scan-submissions (CLI + action) + review-flag slices, `/operator/flags` queue; 278 unit + 12 e2e green
- Depends on: M6
