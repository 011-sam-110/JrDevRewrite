...
- Status: `[x] done (2026-06-10, pending-hash)` — `domain/prize-pools/`: time-driven lifecycle (tick + effects-as-data), entry guards, normalized-Borda vote aggregation; 77 tests
- Depends on: M0
