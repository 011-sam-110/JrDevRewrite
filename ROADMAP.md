...
- Status: `[x] done (2026-06-10, <commit>)` — `domain/gamification/` badges + visibility kernel; `/u/[handle]` public profile, `/leaderboard` global + per-role, privacy toggle; 393 unit + 16 e2e green
- Depends on: M9
