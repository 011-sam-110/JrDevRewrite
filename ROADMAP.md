...
- Status: `[x] done (2026-06-10, <pending>)` — repo-freshness + window kernel rules, `infra/github` push-signal read, `infra/video` (local dev fallback), `submit-entry` slice + UI; 233 unit + 11 e2e green
- Depends on: M5
