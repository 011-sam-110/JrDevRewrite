...
- Status: `[x] done (2026-06-10)` — credit kernel + ledger, `/pools` browse/detail, race-safe join, `pools:tick` lifecycle cron (extension→cancellation+refund verified live); 183 unit + 9 e2e green
- Depends on: M4
