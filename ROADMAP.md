...
- Status: `[x] done (2026-06-11, pending)` — `domain/battles/` (lifecycle + speed/penalty scoring + Phase-2 wager rules) + `domain/gamification/` Elo & battle-XP; 164 new kernel tests, all pure
- Depends on: M0
